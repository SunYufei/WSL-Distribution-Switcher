...
try:
	r = urllib.request.Request('http://6bd335cf.m.daocloud.io/v2/%s/manifests/%s' % (fimage, tag))
...
for layer in manifest['fsLayers']:
	...
	try:
		r = urllib.request.Request('http://6bd335cf.m.daocloud.io/v2/%s/blobs/%s' % (fimage, layer['blobSum']))
